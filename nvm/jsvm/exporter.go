...
func delGlobalStateFunc(workerProc *nvm.WorkerProc) interface{} {
	return func(fc otto.FunctionCall) otto.Value {
		if len(fc.ArgumentList) != 1 {
...
func getStateFunc(workerProc *nvm.WorkerProc) interface{} {
	return func(fc otto.FunctionCall) otto.Value {
		if len(fc.ArgumentList) != 1 {
...
func putStateFunc(workerProc *nvm.WorkerProc) interface{} {
	return func(fc otto.FunctionCall) otto.Value {
		if len(fc.ArgumentList) != 2 {
...
func delStateFunc(workerProc *nvm.WorkerProc) interface{} {
	return func(fc otto.FunctionCall) otto.Value {
		if len(fc.ArgumentList) != 1 {
...
func getByPrefixFunc(workerProc *nvm.WorkerProc) interface{} {
	return func(fc otto.FunctionCall) otto.Value {
		if len(fc.ArgumentList) != 1 {
...
func getByRangeFunc(workerProc *nvm.WorkerProc) interface{} {
	return func(fc otto.FunctionCall) otto.Value {
		if len(fc.ArgumentList) != 2 {
...
func complexQueryFunc(workerProc *nvm.WorkerProc) interface{} {
	return func(fc otto.FunctionCall) otto.Value {
		if len(fc.ArgumentList) != 1 {
