...
import (
	...
	luajson "github.com/bocheninc/L0/nvm/luavm/json"
	"github.com/yuin/gopher-lua"
	"github.com/bocheninc/L0/nvm"
	//"github.com/bocheninc/L0/components/log"
)

func exporter(workerProc *nvm.WorkerProc) map[string]lua.LGFunction {
	return map[string]lua.LGFunction{
		...
		"SetGlobalState":     setGlobalStateFunc(workerProc),
...
func sleepFunc(workerProc *nvm.WorkerProc) lua.LGFunction {
...
func accountFunc(workerProc *nvm.WorkerProc) lua.LGFunction {
	return func(l *lua.LState) int {
...
func transferFunc(workerProc *nvm.WorkerProc) lua.LGFunction {
	return func(l *lua.LState) int {
		if l.GetTop() != 3 {
...
func currentBlockHeightFunc(workerProc *nvm.WorkerProc) lua.LGFunction {
	return func(l *lua.LState) int {
...
func getGlobalStateFunc(workerProc *nvm.WorkerProc) lua.LGFunction {
	return func(l *lua.LState) int {
		if l.GetTop() != 1 {
...
func setGlobalStateFunc(workerProc *nvm.WorkerProc) lua.LGFunction {
	return func(l *lua.LState) int {
		if l.GetTop() != 2 {
...
func delGlobalStateFunc(workerProc *nvm.WorkerProc) lua.LGFunction {
	return func(l *lua.LState) int {
		if l.GetTop() != 1 {
...
func getStateFunc(workerProc *nvm.WorkerProc) lua.LGFunction {
	return func(l *lua.LState) int {
		if l.GetTop() != 1 {
...
func putStateFunc(workerProc *nvm.WorkerProc) lua.LGFunction {
	return func(l *lua.LState) int {
		if l.GetTop() != 2 {
...
func delStateFunc(workerProc *nvm.WorkerProc) lua.LGFunction {
	return func(l *lua.LState) int {
		if l.GetTop() != 1 {
...
func getByPrefixFunc(workerProc *nvm.WorkerProc) lua.LGFunction {
	return func(l *lua.LState) int {
		if l.GetTop() != 1 {
...
func getByRangeFunc(workerProc *nvm.WorkerProc) lua.LGFunction {
	return func(l *lua.LState) int {
		if l.GetTop() != 2 {
...
func complexQueryFunc(workerProc *nvm.WorkerProc) lua.LGFunction {
	return func(l *lua.LState) int {
		if l.GetTop() != 1 {
